...
const String _storageKey = "whatsapp_application";
const List<String> _supporedLanguages = ['en', 'fa'];
...
class GlobalTranslations {
  ...
  supportedLocales() =>
      _supporedLanguages.map<Locale>((lang) => new Locale(lang, ''));
  ...
  Future<Null> init([String defaultLanguage = 'fa']) async {
    if (_locale == null) {
      String language =
          await _getApplicationSavedInformation('currentLanguage');
